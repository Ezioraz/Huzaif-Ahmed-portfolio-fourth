...
import { FaDocker, FaNodeJs, FaGithub, FaAws } from 'react-icons/fa';
import { SiJenkins, SiGnubash, SiAnsible, SiPython, SiAmazoncloudwatch, SiGithubactions, SiJavascrip, SiMaterialdesign, SiLinux, SiKubernetes, SiTerraform  } from 'react-icons/si';
import { TbBrandFramerMotion } from 'react-icons/tb';

const skills = [
    { name: "AWS Cloud", icon: <FaAws className="w-5 h-5 sm:w-6 sm:h-6" />, size: "col-span-2 sm:col-span-1 md:col-span-2 row-span-1" },
    { name: "Linux", icon: <SiLinux className="w-5 h-5 sm:w-6 sm:h-6" />, size: "col-span-1 row-span-1" },
    { name: "Jenkins", icon: <SiJenkins className="w-5 h-5 sm:w-6 sm:h-6" />, size: "col-span-1 row-span-1" },
    { name: "Docker", icon: <FaDocker className="w-5 h-5 sm:w-6 sm:h-6" />, size: "col-span-2 sm:col-span-1 sm:row-span-2 row-span-1" },
    { name: "Kubernetes", icon: <SiKubernetes className="w-5 h-5 sm:w-6 sm:h-6" />, size: "col-span-2 sm:col-span-1 md:col-span-2 row-span-1" },
    { name: "GitHub", icon: <FaGithub className="w-5 h-5 sm:w-6 sm:h-6" />, size: "col-span-1 row-span-1" },
    { name: "Terraform", icon: <SiTerraform className="w-5 h-5 sm:w-6 sm:h-6" />, size: "col-span-1 row-span-1" },
    { name: "Bash Scripting", icon: <SiGnubash className="w-5 h-5 sm:w-6 sm:h-6" />, size: "col-span-1 row-span-1" },
    { name: "Ansible", icon: <SiAnsible className="w-5 h-5 sm:w-6 sm:h-6" />, size: "col-span-1 row-span-1" },
    { name: "Amazon Cloudwatch", icon: <SiAmazoncloudwatch className="w-5 h-5 sm:w-6 sm:h-6" />, size: "col-span-2 sm:col-span-1 md:col-span-2 row-span-1" },
    { name: "Github Actions", icon: <SiGithubactions className="w-5 h-5 sm:w-6 sm:h-6" />, size: "col-span-1 row-span-1" },
    { name: "Python Scripting", icon: <SiPython className="w-5 h-5 sm:w-6 sm:h-6" />, size: "col-span-1 row-span-1" },
];
